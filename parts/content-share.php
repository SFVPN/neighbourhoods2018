...
<div id="share-links" class="center-align">
  <a class="chip" href="https://twitter.com/intent/tweet?url=<?php echo get_permalink(); ?>&via=<?php echo get_theme_mod( 'tcx_twitter_handle' );?>&text=<?php the_title(); ?>" aria-label="Share this content on Twitter">Share on Twitter <i aria-hidden="true" class="mdi mdi-twitter"></i></a>
