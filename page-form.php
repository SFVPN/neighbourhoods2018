...
<div class="acf-input">
<p>Firstly, you must fill in the <strong>Submissions Details</strong> box with the date, name of the user(s) submitting the content and the category of content.</p>
		</div>
</div>
</div>
</div>
